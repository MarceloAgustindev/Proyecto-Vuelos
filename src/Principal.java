...
public class Principal {
	public static void main(String[] args) {
        ...
        String codVueloNacional2 = aerolinea.registrarVueloPublicoNacional("Aeroparque", "Bariloche", "25/11/2024", 8, 5000, preciosNacional, cantAsientosNacional);
        ...
        int codPasaje1a = aerolinea.venderPasaje(12345678, codVueloNacional2, 5, true);
        ...
        System.out.println("Pasaje 2 vendido: " + codPasaje1a);
       ...
       LinkedList<String> vuelosSimilares = aerolinea.consultarVuelosSimilares("Aeroparque", "Bariloche", "10/11/2024");
       System.out.println("Vuelos similares al 10/11/2024 de Aeroparque a Bariloche: " + vuelosSimilares);
        ...
        for (int i = 0; i < acompaniantes.length; i++) {
            acompaniantes[i] = 10000000 + i; // Simplemente como ejemplo DNI de los acompañantes
        ...
        String fechaVueloPrivado = "19/11/2024";
        ...
        try {
            ...
            System.out.println("Error durante la simulación del vuelo privado: " + e.getMessage());
        } 
        if (error)
